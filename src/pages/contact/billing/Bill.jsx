  ...
  return (
    <div className='max-w-[1000px] mx-auto'>
         <div className='max-w-[900] w-full'>
                ...
                <h2 className='font-primaryMedium text-[32px] text-center'>Having trouble with your payments?</h2>
                ...
                {/* <input type="search" name="search" id="search"  className='py-16 rounded-lg w-full bg-gray-200 mt-1'/> */}
                 ...
                 <button className='bg-[#fd4] text-center text-[15px] p-4 rounded-lg mt-10 w-full font-primaryRegular text-[#102]'>Send message</button>
                </div>
         </div>
    </div>
  )
