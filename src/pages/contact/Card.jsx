  ...
  return (
    <div className='max-w-[1000px] mx-auto'>
         <div className='max-w-[900] w-full'>
                ...
                <h2 className='font-primaryMedium text-[32px] text-center'>Fill out this form and our representative will be in touch</h2>
                <p className='font-primaryRegular pt-[10px]  text-[15px] text-gray-600 text-center m-auto max-w-[840px]'>If your question isn't answered above or in the rules then you can contact us using the form below. We will reply to all queries as soon as we can.</p>
                </div>
